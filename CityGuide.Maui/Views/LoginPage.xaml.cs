...
public partial class LoginPage : ContentPage
{
    ...
    {
        await DisplayAlert("Şifremi Unuttum", "Şifre sıfırlama yakında eklenecek.", "Tamam");
    }
    ...
    {
        await DisplayAlert("Google", "Google ile giriş yakında eklenecek.", "Tamam");
    }

    private async void OnAppleTapped(object sender, TappedEventArgs e)
    {
        await DisplayAlert("Apple", "Apple ile giriş yakında eklenecek.", "Tamam");
    }
